...
class IceCreamStand(Restaurant):
    """A simple class that represents an Ice cream stand"""
    ...
    def display_flavors(self, *flavors):
        """This prints our icecream flavors"""
        flavors = ['Vanilla', 'Strawberry', 'Mint', "Chocolate"]

        print(f"Our Ice cream flavors are: {flavors}")
...
our_icecream = IceCreamStand("ColdStore", "Fish and Chips")
our_icecream.display_flavors()
